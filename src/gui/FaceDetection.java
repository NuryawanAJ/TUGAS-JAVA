...
/////////
    ...
    private void btnPauseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPauseActionPerformed
        ...
        btnPause.setEnabled(false);   // aktifkan tombol start
        btnStart.setEnabled(true);     // nonktifkan tombol pause

        webSource.release();  // berhenti mengambil dari kamera
    ...
    private void btnStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStartActionPerformed
        ...
        webSource = new VideoCapture(0); // Mengambil video dari default cam
        myThread = new DaemonThread(); //buat objek dari threat class
        Thread t = new Thread(myThread);
        t.setDaemon(true);
        myThread.runnable = true;
        t.start();                 //start thrad
        btnStart.setEnabled(false);  // nonktifkan tombol start
        btnPause.setEnabled(true);  //  aktifkan tombol pause
